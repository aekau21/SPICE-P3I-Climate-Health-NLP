...
wordcloud(ngrams_5$bigram, freq = ngrams_5$n, max.words = 200, min.freq = 5, random.order = FALSE, color = brewer.pal(8, "GnBu"), family = "Avenir")
...
pyramid.plot(na_1_sentiment_score$score, na_3_sentiment_score$score, labels = na_1_sentiment_score$sentiment, main = "Sentiment Comparison for Claims 1 & 3", gap = 300, top.labels = c("Super Claim 1: CC is Not Happening", "Sentiment", "Super Claim 3: CC is Not Bad"), show.values = TRUE, unit = "Score")
```
