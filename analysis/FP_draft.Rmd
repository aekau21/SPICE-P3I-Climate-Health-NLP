...
ggplot(united_sent_score, aes(x = sentiment)) +
  ...
  scale_fill_manual(values = c("claim_5" = "#ECB713", "claim_1" = "#B713EC", "claim_3" = "#13ECB7")) +
  theme(text = element_text(family = "Avenir Next", size = 21), axis.text.y = element_text(family = "Avenir Next", size = 21), axis.title = element_text(family = "Avenir Next", size = 21)) +
  labs(x = "Sentiment", y = "Score", title = "Sentiment Scores for Super Claims 1, 3, & 5", fill = "Claim")
```
